...
TestData.to_csv("Predictions.csv")
 ...
 Once you have the CSV file submit it to the kaggle. The instructions were given on [Submit Predictions](https://danrunfola.gitbook.io/datasec-challenge/twitter/submitpredictions).
